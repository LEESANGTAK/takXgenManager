...
class XGenManager(QMainWindow):
    ...
    def buildUI(self):
        ...
        scrollArea.customContextMenuRequested.connect(self.__showDescriptionContextMenu)
        ...
        self.__populateDescriptionArea()

        # Connections
        addGuideAction.triggered.connect(lambda: pm.mel.eval('XgGuideTool;'))
        sculptGuideAction.triggered.connect(self.__activateGuidSculptTool)
    ...
    def __populateDescriptionArea(self):
        ...
        for collection in collections:
            ...
            for description in descriptions:
                ...
                self.scrollLayout.addWidget(descriptionWidget)

    def __showDescriptionContextMenu(self, pos):
        menu = QMenu()
        menu.addAction('Refresh', self.__populateDescriptionArea)
    ...
    def __activateGuidSculptTool(self):
        xgui.createDescriptionEditor(False).guideSculptContext(False)
        pm.mel.xgmGuideSculptContext('xgmGuideSculptTool', e=True, lockLength=False)
